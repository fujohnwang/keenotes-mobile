...
class SettingsRepository(private val context: Context) {
    ...
    companion object {
        ...
        private val KEY_SHOW_ON_THIS_DAY_IN_YEARS_PAST = stringPreferencesKey("show_on_this_day_in_years_past")
    ...
    val showOnThisDayInYearsPast: Flow<Boolean> = context.dataStore.data.map {
        it[KEY_SHOW_ON_THIS_DAY_IN_YEARS_PAST]?.toBoolean() ?: true
    }
    ...
    suspend fun setShowOnThisDayInYearsPast(enabled: Boolean) {
        context.dataStore.edit { prefs ->
            prefs[KEY_SHOW_ON_THIS_DAY_IN_YEARS_PAST] = enabled.toString()
        }
    }
